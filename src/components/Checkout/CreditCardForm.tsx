...
const CreditCardForm = ({
	...
	useEffect(() => {
		...
		if (!enteredCardDetails || Object.values(enteredCardDetails).some((value) => value === ''))
			return
		...
		<div className={formStyles}>
			<div className='col-span-4'>
				<TextField
					...
					onChange={(e) =>
						setEnteredCardDetails((state) => ({ ...state, cardNumber: e.target.value }))
					}
			...
			<div className='col-span-4'>
				<TextField
					...
					onChange={(e) =>
						setEnteredCardDetails((state) => ({ ...state, cardHolder: e.target.value }))
					}
