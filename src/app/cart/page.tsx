										...
										<li
											...
											<div className='flex flex-1 flex-col justify-center pr-8'>
												...
												<select
													...
													className='mt-1 w-24 rounded-md border border-gray-300 py-1 text-left text-base leading-5 font-medium text-gray-700 shadow-xs focus:border-amber-500 focus:ring-1 focus:ring-amber-500 focus:outline-hidden sm:text-sm'
